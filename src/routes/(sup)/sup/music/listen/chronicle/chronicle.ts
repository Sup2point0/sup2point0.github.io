    ...
    tracks: [
      {
        ...
        artists: ["symmetori"],
        date:    "summer 2026",
        cover:   "selenelion.jpg",
        genres:  [Genre.ELECTRONIC, Genre.RHYTHM, Genre.PIANO],
        links: {
          youtube: "https://youtube.com/watch?v=aW_BPAh3wc8&list=PLYWIouv-DSkA_6f6V_ZChkIKn7_Foqxnd",
        },
