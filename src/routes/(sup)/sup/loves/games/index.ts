  ...
  "franchises": [
    {
      ...
      state:  PlayState.RETIRED,
      desc: [
        `Before rhythm games, this was the game I ${i`trained`}. By that I mean regular, frequent practice whenever I could. I wasn’t especially skilled, but I wasn’t too half bad either. Managed to set some high ranks in events, y’know (usually with the Lykan, lmao).`,
    ...
    },
    {
      ...
      state:  PlayState.RETIRED,
      desc: [
        `Childhood!! I love everything about this game, I’d even call it perfect. I’m biased, obviously, but damn... the music, the upgrades, the bosses, the flavour. It’s so rich and epic. The tiniest things like how the perspective changes for new sections or in boss fights. The feeling of progression as the terrain and planes change.`,
      ],
    },
    {
      shard:  "pvz-2",
  ...
  "runners": [
    {
      ...
      desc: [
        ...
        `I was devastated when this game got discontinued. It was my childhood, even though I only got to play it during holidays. I made a lot conceptual fan-made stuff for this game, hehe. At least I can still play it via APKs on an Android emulator.`,
      ],
    },
    {
      shard:  "minion-rush",
